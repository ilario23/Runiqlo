          ...
          <button
            ...
            className={[
              ...
              disabled
                ...
                : 'bg-[var(--color-surface-2)] border-[var(--color-border)] text-[var(--color-text-2)] hover:border-[var(--color-accent)]/50 hover:text-[var(--text)] hover:bg-[var(--color-accent-dim)] cursor-pointer',
            ].join(' ')}
          >
            {opt.label}
          </button>
