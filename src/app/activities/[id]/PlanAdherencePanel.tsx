...
const TYPE_COLOR: Record<WorkoutType, string> = {
  ...
  recovery_run:  'text-[#64d2ff] border-[#64d2ff]/30 bg-[#64d2ff]/8',
  ...
  cross_training:'text-[#64d2ff] border-[#64d2ff]/30 bg-[#64d2ff]/8',
  rest:          'text-white/30 border-white/10 bg-white/4',
  swim:          'text-[#64d2ff] border-[#64d2ff]/30 bg-[#64d2ff]/8',
